...
public class FxBankCardController {
    ...
    @PostMapping("/{createdPlace}")
    public FxBankCard createInitBankCard(@PathVariable("createdPlace") String createdPlace) {
        return bankCardService.createInitBankCard(createdPlace);
    }
